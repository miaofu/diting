...
option = {
    ...
    legend: {
        data:['CSI500','Amount(10,000 RMB)','Volume'],
...
var myChart2 = echarts.init(document.getElementById('market1'));
...
var myChart3 = echarts.init(document.getElementById('market2'));
