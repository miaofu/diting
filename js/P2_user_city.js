...
var geoCoordMap = {
    ...
    "武汉":[114.31,30.52],
    "大庆":[125.03,46.58],
    "\u5858\u6cbd\u533a": [117.663944, 39.034638], "\u65b0\u52a0\u5761": [103.819836, 1.352083], "\u957f\u5b81\u533a": [121.430394, 31.226487], "\u5357\u5cb8\u533a": [106.568974, 29.527997], "\u548c\u5e73\u533a": [117.221168, 39.123205], "\u6d4e\u5b81": [116.593852, 35.420269], "\u5ba3\u6b66\u533a": [116.395648, 39.902703], "\u5609\u5b9a\u533a": [121.272804, 31.380476], "\u677e\u6c5f\u533a": [121.233011, 31.038472], "\u95f8\u5317\u533a": [121.465963, 31.253373], "\u6fb3\u5927\u5229\u4e9a": [133.775136, 25.274398], "\u9752\u6d66\u533a": [121.130814, 31.155541], "\u6f33\u5dde": [117.653827, 24.519197], "\u4e5d\u9f99\u5761\u533a": [106.517958, 29.507801], "\u5b9d\u5c71\u533a": [121.495971, 31.410955], "\u6cb3\u4e1c\u533a": [118.408395, 35.093146], "\u4e1c\u8425": [118.681046, 37.43999], "\u4e07\u5dde\u533a": [108.415288, 30.813624], "\u4e1c\u57ce\u533a": [116.422773, 39.934772], "\u5b89\u9633": [114.3996, 36.103649], "\u6d77\u6dc0\u533a": [116.304881, 39.965528], "\u671d\u9633\u533a": [116.450111, 39.927669], "\u6c99\u576a\u575d\u533a": [106.464194, 29.547176], "\u95f5\u884c\u533a": [121.388672, 31.118893], "\u9759\u5b89\u533a": [121.462365, 31.22977], "\u8679\u53e3\u533a": [121.511736, 31.270157], "\u5362\u6e7e\u533a": [121.481238, 31.213348], "\u5357\u5f00\u533a": [117.156626, 39.144153], "\u6c5f\u5317\u533a": [121.5611, 29.892502], "\u6d66\u4e1c\u65b0\u533a": [121.550544, 31.22739], "\u77f3\u666f\u5c71\u533a": [116.229603, 39.911344], "\u897f\u57ce\u533a": [116.372623, 39.918236], "\u901a\u5dde\u533a": [121.079419, 32.073984], "\u82f1\u56fd": [-3.435973, 55.378051], "\u660c\u5e73\u533a": [116.237897, 40.226486], "\u666e\u9640\u533a": [121.403569, 31.255173], "\u5927\u5174\u533a": [116.348215, 39.732495], "\u9ec4\u6d66\u533a": [121.491194, 31.237372], "\u6e1d\u4e2d\u533a": [106.575039, 29.559433], "\u52a0\u62ff\u5927": [-106.346771, 56.130366], "\u5d07\u6587\u533a": [116.425782, 39.901383], "\u5f90\u6c47\u533a": [121.443266, 31.194616], "\u6cb3\u897f\u533a": [117.229775, 39.115763], "\u6768\u6d66\u533a": [121.532609, 31.265486]
};
/*
var data = [
    {name: "海门", value: 9},
...
option = {
    ...
    title: [
        {
            text: '雪球网用户分布图',
            subtext: 'data from xueqiu',
            sublink: 'https://xueqiu.com/',
            left: 'center',
            textStyle: {
                color: '#fff'
            }
...
function renderBrushed(params) {
    ...
    this.setOption({
        ...
        title: {
            id: 'statistic',
            text: count ? '平均: ' + (sum / count).toFixed(4)*100 : ''
        },
        series: {
            id: 'bar',
            data: barData
