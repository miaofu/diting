...
var schema = [
    {name: 'AQIindex', index: 1, text: 'ID'},
    {name: 'AQIindex2', index: 2, text: '关注人'},
    {name: 'PM25', index: 3, text: '关注股票'},
    {name: 'PM10', index: 4, text: '粉丝'},
    {name: 'CO', index: 5, text: '发文数量'},
    {name: 'NO2', index: 6, text: '社交网络'},
